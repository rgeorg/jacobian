...
% Last Modified by GUIDE v2.5 04-Jun-2017 12:19:47
...
% --- Executes on button press in gen_sol.
function gen_sol_Callback(hObject, eventdata, handles)
% hObject    handle to gen_sol (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[handles.d] = generateSolutions(handles.s, handles.d);
handles.s.J33
handles.s.detJ33
handles.s.detJ33factors
handles.d.detJ33
set(handles.foobar,'String',{ ...
        'Jacobian', ...
        char(handles.s.J33), [], ...
        'Determinant', ...
        char(handles.s.detJ33), num2str(handles.d.detJ33), [], ...
        'Determinant factors', ...
        char(handles.s.detJ33factors), [] ...
    })
